...
url <- "https://cdn.rawgit.com/i2alex/Privatization-in-Ukraine.-1992-2015/6bd2543c/Data/fixed%20assets.xlsx"
if(!file.exists("fixed assets.xlsx")){
        download.file(url, destfile = "direct.investments.goskomstat", method = "curl")
}
...
##### Рис.73. Прямые иностранные инвестиции в Украину по годам (млн.дол.США)
...
##### Рис.74. Доля оффшорных стран в прямых иностранных инвестициях в Украину по годам (%)[^footnote71]. 
...
Среднее ежегодное значение инвестиций на душу населения в Украине за последние 25 лет самые низкое среди выбранных для сравнения стран – всего 69 дол.США. Это в два раза меньше, чем в РФ и в 4,5 раза меньше, чем в Латвии. (Рис.75)[^footnote72].
При этом, необходимо отметить, что если в 1995 году Латвия опережала РФ по количеству инвестиций на душу населения в 10 раз (!), то уже в 2014, РФ обогнала Латвию почти на 10% (рис.76)[^footnote73].


##### Рис.75. Общий объем инвестиций как % от ВВП[^footnote74].
...
[^footnote70]:  http://data.worldbank.org/indicator/BX.KLT.DINV.CD.WD

[^footnote71]: http://www.ukrstat.gov.ua/operativ/operativ2016/zd/ivu/ivu_u/ivu0116.html. ДОБАВИТЬ ССЫЛКУ НА СОБСТВЕННЫЙ ИСТОЧНИК

[^footnote72]: http://eucham.eu/charts/153-2015-03-foreign-direct-investment-per-capita-in-europe и глобальная база данных NationMaster http://www.nationmaster.com/country-info/stats/Economy/Foreign-direct-investment

[^footnote73]: Там же 

[^footnote74]:  http://data.worldbank.org/indicator/NE.GDI.TOTL.ZS

[^footnote75]: См.детальную классификацию стран Мировым Банком  http://blogs.worldbank.org/opendata/new-country-classifications

[^footnote76]: http://data.worldbank.org/indicator/BX.KLT.DINV.CD.WD

[^footnote77]: http://data.worldbank.org/indicator/NY.GSR.NFCY.CD
