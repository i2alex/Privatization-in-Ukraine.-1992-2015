...
####  Рис_ Объекты к приватизации в 2016-2017 гг по группам
```{r}
# Очистка данных
...
ggplot(data = Number.privatization.companies.2016, aes(x = Privatization.Group, y = Number.of.enterprises.for.privatization, fill = Privatization.Group ))+
        ...
        ggtitle("Fig_ Objects for privatization in 2016-2017 by groups")
...
####  Рис.__ Объекты приватизации в 2016-2017 гг по группам (%)
```{r}
...
####  Рис.__ Объекты приватизации 2016-2017 гг по видам экономической деятельности 
```{r, fig.width=7}
...
ggplot(data = Number.priv.comp.by.activity, aes(x = Economic.activity, y = Number.of.enterprises.for.privatization, fill = Economic.activity))+
        ...
        guides(fill=FALSE)+
        ggtitle("Fig._. Objects of privatization of 2016-2017 by types of 
                economic activity")+
        coord_flip()
...
ggplot(data = PercGr.priv.comp.by.activity, aes(x = Economic.activity, y = Percent.Of.the.total, fill = Economic.activity))+
        ...
        ylab("Type of economic activity")+
        guides(fill=FALSE)+
        ggtitle("Fig._. Objects of privatization in 2016-2017 by types of 
                economic activity (%)")+
        coord_flip()
...
####  Рис._ Предприятия сельского хозяйства, готовящиеся к приватизации, по группам 
```{r}
# Создание таблицы с количеством предприятий каждой категории подлежащих приватизации согласно последнего плана
...
####  Рис.__. Подотрасли агропромышленных предприятий, планируемые к приватизации в 2016-2017 гг. 
```{r, fig.width=7}
...
ggplot(data = sub_sectors.agro, aes(x = Name.of.sub.sector, y = Number.of.enterprises, fill = Name.of.sub.sector))+
        ...
        ggtitle("Fig._. Sub-sectors of agro-industrial enterprises planned for 
...
####  Рис. _.  Научно-исследовательские и другие институты, готовящиеся к приватизации по отраслям
...
ggplot(data = direction.science, aes(x = The.direction.of.the.research.institute, y = Number.of.institutes, fill = The.direction.of.the.research.institute))+
        ...
        xlab("Sub-sectors of the agro-industrial complex")+
        ylab("Number of enterprises")+
        ggtitle("Fig._. Research and other institutions preparing for privatization 
                by industry.")+
        coord_flip()+
        scale_fill_brewer(palette="Pastel2") +
        guides(fill=FALSE)
...
####  Рис.__. Научно-исследовательские и другие институты, готовящиеся к приватизации по группам
```{r}
# Создание таблицы с количеством предприятий каждой категории подлежащих приватизации согласно последнего плана
...
ggplot(N.priv.science, aes(x="", y=Number.of.enterprises, fill=Privatization.Group)) +
      ...
      geom_text(aes(x=1.4, label=Number.of.enterprises), 
                position=position_stack(vjust=0.5), size=4) +
        ggtitle("Fig_ Research and other institutions preparing for 
...
####  Рис.__. Предприятия машиностроения, готовящиеся к приватизации в 2016-2017 гг по группам
```{r, fig.width=7}
...
ggplot(N.priv.machine.industry, aes(x="", y=Number.of.enterprises, fill=Privatization.Group)) +
      ...
      geom_text(aes(x=1.4, label=Number.of.enterprises), 
                position=position_stack(vjust=0.5), size=4) +
        ggtitle("Fig_ The enterprises of mechanical engineering, which are preparing 
...
####  Рис.__. Предприятия транспортной отрасли, которые готовятся к приватизации в 2016-2017 гг по видам транспорта
```{r, fig.width=7}
...
ggplot(data = sub_sectors.transport, aes(x = Name.of.sub.sector, y = Number.of.enterprises, fill = Name.of.sub.sector))+
        ...
        xlab("Sub-sectors of the agro-industrial complex")+
        ylab("Number of enterprises")+
        ggtitle("Fig._. Enterprises of the transport sector, which are preparing for 
...
####  Рис._ Предприятия транспортной отрасли, которые готовятся к приватизации в 2016-2017 гг по группам
```{r}
# Создание таблицы с количеством предприятий каждой категории подлежащих приватизации согласно последнего плана
...
####  Рис.__. Предприятия добывающей промышленности, которые готовятся к приватизации в 2016-2017 гг по подвидам экономической деятельности 
```{r, fig.width=7}
# Создание таблицы предприятий транспортной отрасли с разбивкой по подотраслям
...
ggplot(data = sub_sectors.extractive.industry, aes(x = Name.of.sub.sector, y = Number.of.enterprises, fill = Name.of.sub.sector))+
        ...
        xlab("Sub-sectors of the agro-industrial complex")+
        ylab("Number of enterprises")+
        ggtitle("Fig._. The enterprises of the extractive industry, which are preparing 
...
####  Рис._ Предприятия добывающей промышленности, которые готовятся к приватизации в 2016-2017 гг по группам
```{r, fig.width=7}
# Создание таблицы с количеством предприятий каждой категории подлежащих приватизации согласно последнего плана
...
ggplot(N.priv.extracting.industry, aes(x="", y=Number.of.enterprises, fill=Privatization.Group)) +
      ...
      geom_text(aes(x=1.4, label=Number.of.enterprises), 
                position=position_stack(vjust=0.5), size=4) +
        ggtitle("Fig_ Enterprises of the extractive industry, which are preparing for 
...
### ЭНЕРГЕТИКА
Из 26 предприятий топливно-энергетического комплекса, которые планируются к приватизации, требует разрешения на приватизацию только 1 предприятие – ГП «Смолы», производящее ионообменные материалы, применяющиеся, в частности, в атомной энергетике. Остальные предприятия не входят в список запрещенных к приватизации. Среди них – 14 энерго-генерирующих компании, 6 теплоэлектроцентралей, 3 гидроэлектростанции, 1 компания газоснабжения. 

####  Рис.__. Предприятия энергетического комплекса, которые готовятся к приватизации в 2016-2017 гг
...
ggplot(data = sub_sectors.energy.complex, aes(x = Name.of.sub.sector, y = Number.of.enterprises, fill = Name.of.sub.sector))+
        ...
        xlab("Sub-sectors of the agro-industrial complex")+
        ylab("Number of enterprises")+
        ggtitle("Fig._. Enterprises of the energy complex that are preparing 
...
ggplot(data = Privatized_companies, aes(x = Companies.class, y = Number.of.privatized.companies, 
        ...
        ggtitle("Fig.1. Number of enterprises privatized by 2016 
                by groups")
...
ggplot(data = all_phases, aes(x = Companies.class, y = Number.of.privatized.companies, 
        ...
        xlab("Class of privatized companies")+
        ylab("Number of privatized companies")+
        ggtitle("Fig.2. Number of privatized enterprises by groups")+
...
ggplot(data = Priv_economic_activity, aes(x = economic.activity, y = number.of.privatized.companies.on.01.01.2005, 
        ...
        ylab("Number of privatized companies")+
        ggtitle("Fig.3. Number of privatized companies by industries 
                on.01.01.2005")+
        guides(fill=FALSE)
```
...
ggplot(data = OwnershipData, aes(x = year, y = number.of.enterprices, 
        ...
        xlab("Class of privatized companies")+
        ylab("Number of privatized companies")+
        ggtitle("Fig.4. Number of state and private enterprises in 
                Ukraine by years")
```
...
ggplot(data = PrivIndexEBRD, aes(x = year, y = privatization.index, 
        ...
        ggtitle("Fig.5. EBRD's assessment of the level of privatization 
                by years.")+
...
К каким результатам в экономике Украины, в совокупности с другими факторами, привело такое структурное изменение собственности? Как отразилось это на поступлениях в государственный бюджет? Что произошло на рынке труда и был ли решон вопрос бедности? Каким пктем пошло развитие промышленности страны?
...
ggplot(data = BudgetPriv_per2Phases, aes(x = Year, y = Million.USD, fill = Year))+
        ...
        xlab("Years")+
        ylab("Millions USD")+
        ggtitle("Fig.8. Comparison of revenues to the budget from 
...
ggplot(data = Penalties_per_violation2, aes(x = year, y = Number, size=Number, group = 1))+
        ...
        ggtitle("Fig.14. Penalties accrued for violating the terms of 
...
#### Рис.19а. ВВП Украины 1990-2015 гг. (ном.дол.США).
...
p1 <- ggplot(data = gdp_data_ua90, aes(x = Year, y = `GDP Billions USD`, group = 1))+
        ...
        xlab("Year")+
        ylab("Billions USD")+
        ggtitle("Fig.19a. GDP of Ukraine 1990-2015. (Nom. US dollars).")+
        guides(fill=FALSE)
...
p2 <- ggplot(data = compar.90.15, aes(x = Year, y = `GDP Billions USD`, fill = Year))+
        ...
        xlab("Year")+
        ylab("Billions USD")+
        ggtitle("Fig.19a. Comparison of GDP in 1990 and 2015")       
...
ggplot(data = Employed_in_economic, aes(x = year, y = number, fill = category))+
        ...
        xlab("Year")+
        ylab("Million people")+
        ggtitle("The population engaged in economic activity and the 
...
ggplot(data = Labour, aes(x = Year, y = Million.People))+
        ...
        xlab("Year")+
        ylab("Million People")+
        ggtitle("Fig.28. Employment of the population of Ukraine by 
...
ggplot(data = Labour_force_agriculture, aes(x = `Organizational forms of employment in the Agriculture`, y = `% Of employees`))+
        ...
        xlab("Organizational forms of employment")+
        ylab("% Of employees")+
        ggtitle("Fig.31. Structure of employment in the Agriculture industry in 
...
ggplot(data = bitumen, aes(x = Year, y = Value))+
        ...
        xlab("Year")+
        ylab("Thousand tones")+
        ggtitle("Fig.39b. Bitumen of oil(Thousand tones)")+
        geom_text(aes(label=Value), position=position_dodge(width=0.9), vjust=-0.35)
...
ggplot(data = excavators, aes(x = Year, y = Value))+
        ...
        xlab("Year")+
        ylab("Pieces")+
        ggtitle("Fig.42.a. Manufacture of excavating machines by years")+
        geom_text(aes(label=Value), position=position_dodge(width=0.1), vjust=-0.35)
...
ggplot(data = bread, aes(x = Year, y = Value))+
        ...
        xlab("Year")+
        ylab("Thousand tons")+
        ggtitle("Fig.43.c. Production of bread and bakery products by years (thousand tons)")+
        geom_text(aes(label=Value), position=position_dodge(width=0.1), vjust=-0.35)
...
ggplot(data = sausages, aes(x = Year, y = Value))+
        ...
        xlab("Year")+
        ylab("Thousand tons")+
        ggtitle("Fig.43.d. Production of sausage products by years")+
        geom_text(aes(label=Value), position=position_dodge(width=0.1), vjust=-0.35)
...
ggplot(data = butter, aes(x = Year, y = Value))+
        ...
        xlab("Year")+
        ylab("Thousand tons")+
        ggtitle("Fig.43.e. Production of butter by year ")+
        geom_text(aes(label=Value), position=position_dodge(width=0.1), vjust=-0.35)
...
ggplot(data = natural.sands, aes(x = Year, y = Value))+
        ...
        ggtitle("Fig.46f. Extraction of sand.")+
        geom_text(aes(label=Value), position=position_dodge(width=0.1), vjust=-0.35)
```

#### Рис. 46.з. Добыча коалина и глины коалиновой (тыс.т.)
...
ggplot(data = kaolin, aes(x = Year, y = Value))+
        ...
        xlab("Year")+
        ylab("Thousand tones")+
        ggtitle("Fig. 46.g. Extraction of the coal and clay coal.")
```

#### Рис. 46.и. Добыча соли и хлорида натрия (тыс.т.)
...
ggplot(data = salt.sodium, aes(x = Year, y = Value))+
        ...
        xlab("Year")+
        ylab("Thousand tones")+
        ggtitle("Fig. 46.i. Extraction of salt and sodium chloride .")+
        geom_text(aes(label=Value), position=position_dodge(width=0.1), vjust=-0.35)
```
...
Честно говоря, хотелось бы объяснить такое снижение другими, более оптимистичными, причинами – например, увеличением потребления лома металлургической промышленностью Украины за счет ее стремительного развития, но, к сожалению, это не так. Экспорт продуктов металлургии за тот же период  упал более чем в 2 раза (Рис.  49)[^footnote44]. 

#### Рис.49. Экспорт изделий из недрагоценных металлов по годам (млрд.дол.США)
```{r}
...
ggplot(data = n_precious.metals.export, aes(x = Year, y = thousand.US.dollars, fill = thousand.US.dollars))+
        ...
        ggtitle("Fig.49. Exports of products from non-precious metals 
                by years")
```
...
Так, по данным общественной организации ветеранов флота Черноморского морского пароходства, в 1990 году компания владела 300 судами различных типов общим дедвейтом 5 млн т. На 1991 г. цена ЧМП составляла $7 млрд, флот насчитывал 295 судов и 1100 единиц вспомогательных судов. Суда списывались как устаревшие, передавались в оффшорные компании в управление, арестовывались в заграничных портах «за долги». На начало 1998 г. на балансе пароходства оставалось уже 15 судов, а в 2004 г. - всего 6[^footnote47]. Вторая по величине в мире (!) судоходная компания практически перестала существовать. (см.Рис.50.). 

#### Рис. 50. Динамика изменения количества судов во владении Черноморского морского пароходства (ед.).
```{r, fig.width=7}
...
ggplot(data = Navy.ships, aes(x = Year, y = Number.of.ships))+
        ...
        xlab("Year")+
        ylab("Number of ships")+
        ggtitle("Fig.52. The Ukrainian Navy. Number of fleet units 
                by year (units)")
...
ggplot(data = shipbuilding.employees, aes(x = Year, y = Employees, fill = Shipbuilding.enterprise))+
        ...
        scale_fill_brewer(palette="Pastel2") +
        ggtitle("Fig.53. Number of employees of 3 shipbuilding 
...
ggplot(data = human.resources.shipbuilding, aes(x = Year, y = Number.of.people))+
        ...
        xlab("Year")+
        ylab("Number of ships")+
        ggtitle("Fig.54. Personnel potential of Ukrainian shipbuilding 
...
ggplot(data = shipbuilding.industry, aes(x = Year, y = Volumes.of.production.million.USD.))+
        ...
        xlab("Year")+
        ylab("million USD")+
        ggtitle("Fig. 55. Volumes of production of the shipbuilding 
                industry of Ukraine.")
```
...
ggplot(data = Monopoly_ua, aes(x = Market.type, y = `Market.share(%)`, fill = Market.type))+
        ...
        ylab("Market type")+
        scale_fill_brewer(palette="Pastel2") +
        ggtitle("Fig. 57. Dynamics of monopolization of the Ukrainian market by years (%)")+
        coord_flip()+
...
ggplot(data = Monopoly_by_activity.compet, aes(x = Economic.activity, y = `%`, fill = `%`))+
        ...
        ggtitle("Fig. 58 Competitive structure of markets by types of 
...
И, наконец, монополии (рынки, на которых доля крупнейшего предприятия составляла более 90 процентов) по видам экономической деятельности были представлены следующим образом. Самый монополизированный рынок в Украине в сфере водоснабжения, водоотведения и обращения с отходами (96,16%),  научная, техническая и профессиональная деятельность (64,72%), транспорт, складское хозяйствование, почта и курьерская доставка (33,7%) а так же поставка электроэнергии, газа, пара и др. (30,48%) (рис.61)[^footnote67].
...
ggplot(data = Monopoly_by_activity.monopoly, aes(x = Economic.activity, y = `%`, fill = `%`))+
        ...
        ylab("Level (in %)")+
        #scale_fill_brewer(palette="Pastel2") +
        ggtitle("Fig.61. Monopolies by types of economic activity 
                in 2015(%)")+
        coord_flip()+
        guides(fill=FALSE)
```
...
По отраслям национальной экономики конкурентные условия рынка выглядят следующим образом (рис.62-67)[^footnote68].
...
ggplot(data = f.a.i.category, aes(x = Category, y = `Million USD`, fill = Category))+
        ...
        guides(fill=FALSE)+
        #scale_fill_brewer(palette="Pastel2") +
        ggtitle("Fig.69. Investments in fixed assets of enterprises by 
...
ggplot(data = depreciation.fa, aes(x = Year, y = Depreciation.of.fixed.assets))+
        ...
        ggtitle("Fig. 70. Degree of depreciation of fixed assets of 
...
#### Рис.73a. Прямые иностранные инвестиции в Украину по данным разных источников за период 1994 - 2013 гг. (млн.дол.США)
```{r, fig.width=7}
...
#### Рис.74. Доля оффшорных стран в прямых иностранных инвестициях в Украину по годам (%)[^footnote75]. 
...
ggplot(data = Offshore_investments, aes(x = Year, y = `% of offshore zones investments`, fill = `% of offshore zones investments`))+
        ...
        ggtitle("Fig.74. The share of offshore countries in foreign direct 
...
#### Рис.74a. Доля оффшорных стран и Нидерландов в прямых иностранных инвестициях в Украину по годам (%)[^footnote76].
```{r, fig.width=6}
...
#### Рис.75. Общий объем инвестиций как % от ВВП[^footnote79].
...
#### Рис.77. Чистый иностранный доход Украины 1992-2015 гг (млн.дол.США)  
...
nfi.UA$date <- as.numeric(nfi.UA$date)
        ...
        ylab("million USD")+
        geom_smooth(method = "loess")+
        ggtitle("Fig.77. Net foreign income of Ukraine in 1993-2015. 
                (million US dollars)")
...
#### Рис.78. Чистый иностранный доход стран ЕС и некоторых стран бывшего СССР (суммарно за 10 лет, с 2005 по 2015)(млрд.дол.США)
...
ggplot(data = nfi.EUandUSSR.05.15, aes(x = country, y = value, fill=country))+
        ...
        xlab("Country")+
        ylab("Billion USD")+
        ggtitle("Fig.78. Net foreign income of the EU countries and some countries 
...
#### Рис.78a. Чистый иностранный доход стран ЕС и некоторых стран бывшего СССР (суммарно за 10 лет, с 2005 по 2015)(млрд.дол.США)
...
ggplot(data = soeFG500, aes(x = Year, y = Percent, fill = Percent))+
        ...
        ggtitle("Fig.79. The share of state enterprises in the Fortune 
...
ggplot(data = soeFG2000, aes(x = Country, y = Percent, fill = Country))+
        ...
        ggtitle("Fig.80. The share of state enterprises in the Fortune Global 500 ranking by years")
...
ggplot(data = soe.in.top10, aes(x = Country, y = Percent, fill = Country))+
        ...
        ylab("%")+
        coord_flip()+
        ggtitle("Fig.81. Share of GP in the top 10 companies in the country (2013)")
...
#### Рис.82 Доля ГП по секторам экономической деятельности среди компаний Форбс Глобал 2000 (2011 г.).
```{r, fig.height=7, fig.width=9}
...
ggplot(data = soe.in.ec.activity, aes(x = Type.of.economic.activity, y = Percent, fill = Type.of.economic.activity))+
        ...
        ylab("%")+
        coord_flip()+
        ggtitle("Fig.82. The share of state enterprises by sectors of economic activity (2011)")
...
[^fn11]: http://www.nfuel.gov.ua/content/derzhavne-p%D1%96dpri%D1%94mstvo-smoli
