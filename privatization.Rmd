...
Авторам думается, что любой житель Украины среднего возраста назовет из своего опыта или информации, запомнившейся из сообщений СМИ, хотя бы один частный пример продажи «на металлолом» некогда прибыльного, работавшего в три смены предприятия.  Особенно эта практика была присуща периоду «большой приватизации» (до 2000 года).  Некоторым образом, оперируя общими цифрами, эту тенденцию можно отследить и в динамике сокращения экспорта металлолома из Украины после завершения этапа «большой приватизации».  Так, с 2006 по 2016 гг. экспорт лома черных металлов снизился почти в 3 раза. (рис.48.). [43. Добавить ссылку на наши таблицы «экспорта-импорта»]
...
Честно говоря, хотелось бы объяснить такое снижение другими, более оптимистичными, причинами – например, увеличением потребления лома металлургической промышленностью Украины за счет ее стремительного развития, но, к сожалению, это не так. Динамика снижения экспорта продуктов металлургии за тот же период  более чем в 2 раза (Рис.  49)[44. Добавить ссылку на наши таблицы «экспорта-импорта»] и снижение общих объемов производства основных изделий этой отрасли, приведенные выше, подтверждают это. 
...
```{r}
# Creation of a data table of the employees of the main shipbuilding plants of Nikolaev for 1990 and 2015
...
**_Количество сотрудников 3-х кораблестроительных заводов Николаева_**
```{r}
...
```{r}
# Creation of a data table of the personnel potential of the shipbuilding industry of Ukraine by years
...
Катастрофически сократились, конечно же, и объемы производства отрасли - с 2.млрд.дол.США в 1988 году до 300 млн.дол.США (в 15 раз) в 2006 г. (рис.55)[^footnote58], и до 150 млн.дол.США (в 30 раз по сравнению с 1988 г), в 2015 году. 
...
[^footnote43]: Добавить ссылку на наши таблицы «экспорта-импорта»
